...
public class FileOpsTest {
    public final static String EXISTING_FILE_PATH = CSVFiles.EXISTING_FILE_PATH;
    ...
    public final static String NOT_EXISTING_FILE_PATH = CSVFiles.NOT_EXISTING_FILE_PATH;
    public final static String NOT_EXISTING_FILE_NAME = CSVFiles.NOT_EXISTING_FILE_NAME;
    public final static String NOT_EXISTING_FULL_FILE_PATH = NOT_EXISTING_FILE_PATH + File.separator + NOT_EXISTING_FILE_NAME;
    public final static String EXISTING_PATH_NOT_EXISTING_FILE_FULL_PATH = EXISTING_FILE_PATH + File.separator + NOT_EXISTING_FILE_NAME;
    public final static String NOT_EXISTING_CREATED_JUST_FOR_TESTS_FULL_FILE_PATH = EXISTING_FILE_PATH + File.separator + "JustForTests_" + NOT_EXISTING_FILE_NAME;
    ...
    void openExistingFile1() throws FileOpenException {
        assertNotNull(FileOps.openExistingFile(EXISTING_FILE_PATH, EXISTING_FILE_NAME));
        assertThrows(FileOpenException.class, () -> FileOps.openExistingFile(NOT_EXISTING_FILE_PATH, NOT_EXISTING_FILE_NAME));
    }
    ...
    void openNewFile1() throws FileOpenException {
        assertNotNull(FileOps.openNewFile(EXISTING_FILE_PATH, NOT_EXISTING_FILE_NAME));
        assertThrows(FileOpenException.class, () -> FileOps.openNewFile(NOT_EXISTING_FILE_PATH, NOT_EXISTING_FILE_NAME));
        assertThrows(FileOpenException.class, () -> FileOps.openNewFile(EXISTING_FILE_PATH, EXISTING_FILE_NAME));
    }
    ...
    @Order(16)
    void isDirectory() {
        assertTrue(FileOps.isDirectory(EXISTING_FILE_PATH));
        assertFalse(FileOps.isDirectory(NOT_EXISTING_FILE_PATH));
