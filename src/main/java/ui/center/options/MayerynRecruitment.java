...
public class MayerynRecruitment implements CenterUIInterface {
    public static final String VIEW_FILE_NAME = "MayerynRecruitment.fxml";
    public static final String VIEW_FILE_PACKAGE = "ui" + File.separator + "center" + File.separator + "options";

    private Parent parent;
    private MayerynRecruitmentController controller;

    public MayerynRecruitment() {
        try {
            initController();
        } catch(IOException e) {
            e.printStackTrace();
