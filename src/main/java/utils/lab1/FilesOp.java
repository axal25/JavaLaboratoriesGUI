...
public class FilesOp {
    ...
    public static File tryNewFile(String fileName) {
        ...
        try {
            if( fileName == null || fileName.isEmpty() ) {
                ...
                throw new FileOpenException(FilesOp.class.getName(), functionName, fileName, cause);
            }
    ...
    public static FileReader closeFileReader(FileReader fileReader) {
        ...
        try {
            if( fileReader == null ) {
                throw new FileReaderCloseException(FilesOp.class.getName(), functionName, "function parameter FileReader fileReader == null");
            }
            fileReader.close();
            return fileReader;
    ...
    public static BufferedReader openBufferedReader(FileReader fileReader) {
        ...
        if( fileReader == null ) {
            try {
                throw new BufferedReaderOpenException(FilesOp.class.getName(), functionName, "function parameter FileReader fileReader == null");
    ...
    public static BufferedReader closeBufferedReader(BufferedReader bufferedReader) {
        ...
        try {
            if( bufferedReader == null ) {
                throw new BufferedReaderCloseException(FilesOp.class.getName(), functionName, "function parameter BufferedReader bufferedReader == null");
            }
        ...
        try {
            if (file != null) {
                if (file.exists() && file.isFile()) {
                    return Long.valueOf( file.length() ).doubleValue();
                } else {
                    throw new GetFileSizeException(FilesOp.class.getName(), functionName, "function parameter File file.exists() == false");
                }
            } else {
                throw new GetFileSizeException(FilesOp.class.getName(), functionName, "function parameter File file == null");
            }
    ...
    public static FileWriter closeFileWriter(FileWriter fileWriter) {
        ...
        try {
            if( fileWriter == null ) {
                throw new FileWriterCloseException(FilesOp.class.getName(), functionName, "function parameter FileWriter fileWriter == null");
            }
            fileWriter.close();
            return fileWriter;
    ...
    public static BufferedWriter openBufferedWriter(FileWriter fileWriter) {
        ...
        if( fileWriter == null ) {
            try {
                throw new BufferedWriterOpenException(FilesOp.class.getName(), functionName, "function parameter FileWriter fileWriter == null");
    ...
    public static BufferedWriter closeBufferedWriter(BufferedWriter bufferedWriter) {
        ...
        try {
            if( bufferedWriter == null ) {
                throw new BufferedWriterCloseException(FilesOp.class.getName(), functionName, "function parameter BufferedWriter bufferedWriter == null");
            }
    ...
    public static File renameFile( File currentFile, File newFile ) {
        ...
        try {
            if( FilesOp.openExistingFile( currentFile.getAbsolutePath() ) == null )
                throw new RenameFileException(FilesOp.class.getName(), functionName, "parameter File currentFile doesn't exist");
            if( FilesOp.openNewFile( newFile.getAbsolutePath()) == null )
                throw new RenameFileException(FilesOp.class.getName(), functionName, "parameter File newFile already exists");
            boolean didRenameSucceed = currentFile.renameTo( newFile );
            if( didRenameSucceed ) {
                return newFile;
            }
            else {
                throw new RenameFileException(FilesOp.class.getName(), functionName, "returned value by \"currentFile.renameTo( newFile )\" == FALSE");
            }
        }
    ...
    public static String renameFile( String currentFullFilePath, String newFullFilePath ) {
        File currentFile = FilesOp.openExistingFile( currentFullFilePath );
        if( currentFile == null ) return null;
        File newFile = FilesOp.openNewFile( newFullFilePath );
        if( newFile == null ) return null;
        newFile = FilesOp.renameFile( currentFile, newFile );
        if( newFile == null ) {
            return null;
        }
        else {
